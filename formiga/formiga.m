...
% Last Modified by GUIDE v2.5 22-Oct-2014 17:26:22
...
% --- Executes on button press in selec_function.
function selec_function_Callback(hObject, eventdata, handles)
% hObject    handle to selec_function (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
